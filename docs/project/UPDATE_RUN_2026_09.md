...
This branch is the reviewable stability-and-feature pass for **StaffRoot** (Python/Tkinter/SQLite). It intentionally excludes user databases, credentials, private inventory, generated caches, and machine-local configuration.

## Priority checks

- credential and role boundaries
- database/backup behavior
- UI module import coverage
